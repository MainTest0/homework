...
public class BackgroundEnemyService extends JFrame implements Runnable {
	...
	public boolean canMove() {
		...
		// 동서남북 검사
		if (direction == RIGHT && rightColor.getRed() == 255 &&
				rightColor.getGreen() == 0 && rightColor.getBlue() == 0) {
			return false;
		} else if (direction == LEFT && leftColor.getRed() == 255 
				&& leftColor.getGreen() == 0 && leftColor.getBlue() == 0) {
			return false;
		} else if (direction == DOWN && bottomColor.getRed() == 255
				&& bottomColor.getGreen() == 0 && bottomColor.getBlue() == 0) {
			return false;
		} else if (direction == UP && topColor.getRed() == 255 
