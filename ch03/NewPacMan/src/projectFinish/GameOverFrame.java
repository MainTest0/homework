...
public class GameOverFrame extends JFrame implements ActionListener {
	...
	private void initData() {
		...
		gameOverMap = new JLabel(new ImageIcon("C:\\jars\\pacman\\images\\gameEndMap.jpg"));
		setContentPane(gameOverMap);
		startButton = new JButton("Game Start!");
		gameOver = new JLabel(new ImageIcon("C:\\jars\\pacman\\images\\gameOver.png"));
		gameSuccess = new JLabel(new ImageIcon("C:\\jars\\pacman\\images\\youWin.png"));
	}
