...
public class PacManFrame extends JFrame {
	...
	public void initData() {
		setTitle("팩맨");
		setSize(800, 800);
		backgroundMap = new JLabel(new ImageIcon("C:\\jars\\pacman\\images\\backgroundMap.png"));
		setContentPane(backgroundMap);
		player = new Player(mContext);
		for (int i = 0; i < seed.length; i++) {
			seed[i] = new JLabel(new ImageIcon("C:\\jars\\pacman\\images\\seed.png"));
		...
		for (int i = 0; i < life.length; i++) {
			life[i] = new JLabel(new ImageIcon("C:\\jars\\pacman\\images\\life.png"));
