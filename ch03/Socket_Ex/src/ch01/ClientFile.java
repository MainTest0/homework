...
//	final String IP = "192.168.0.78";
	...
	public ClientFile() {
		try {
			...
			OutputStreamWriter osw = new OutputStreamWriter(socket.getOutputStream());	// 기반스트림은 대상에 빨대를 꽂음
			// 확장 - 보조 스트림
			BufferedWriter bufferedWriter = new BufferedWriter(osw);	// 기반스트림을 보조스트림에 연결해놓음
